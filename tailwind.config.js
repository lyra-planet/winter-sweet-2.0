  ...
  theme:{
    ...
    extend:{
      ...
      keyframes:({theme})=>({
        ...
        modal:{
          '0%':{transform:"translateY(-100%) translateX(-50%) scale(90%)"},
          '20%':{transform:"translateY(100%) translateX(-50%) scale(100%)"},
          '80%':{transform:"translateY(100%) translateX(-50%)scale(100%)"},
          '100%':{transform:"translateY(-100%) translateX(-50%) scale(100%)"},
        }
      })
    }
  },
